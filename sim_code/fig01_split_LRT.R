...
# Evaluate coverage of split LRT over a grid.
...
for(row in 1:nrow(results)) {
  ...
  # Does split LRT universal confidence set cover true theta?
  results[row, split_LRT_cov := sum((test_point - Y_0_bar)^2) <= 
